...
if ('D:\Documents\Side project website\Xaamp\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('D:\Documents\Side project website\Xaamp\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
